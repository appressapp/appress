...
class Is_Android_App extends \Voxel\Dynamic_Data\Visibility_Rules\Base_Visibility_Rule {

	public function get_type(): string {
		return 'appress:is_android';
	}

	public function get_label(): string {
		return _x( 'Is inside Android App', 'visibility rules', 'appress' );
	}
